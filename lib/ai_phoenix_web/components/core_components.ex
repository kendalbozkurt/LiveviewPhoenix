defmodule AiPhoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AiPhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AiPhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
